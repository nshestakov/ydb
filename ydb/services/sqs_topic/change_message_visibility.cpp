...
namespace NKikimr::NHttpProxy {
    ...
    template<>
    void DeserializeXml(NHttp::THttpIncomingRequestPtr& request, Ydb::Ymq::V1::ChangeMessageVisibilityRequest& value) {
    ...
    template<>
    void DeserializeXml(NHttp::THttpIncomingRequestPtr& request, Ydb::Ymq::V1::ChangeMessageVisibilityBatchRequest& value) {
        auto params = NSQS::ParseParameters(request);
        ...
        for (const auto& entry : params.BatchEntries) {
            ...
            batch_entry->set_visibility_timeout(entry.second.VisibilityTimeout.GetRef());
        }
    }
