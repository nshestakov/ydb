...
namespace NKikimr::NHttpProxy {
    ...
    template<>
    void DeserializeXml(NHttp::THttpIncomingRequestPtr& request, Ydb::Ymq::V1::SetQueueAttributesRequest& value) {
        ...
        //     auto& attribute = *value.add_attributes();
        //     attribute.set_name(attribute.second.name());
        //     attribute.set_value(attribute.second.value());
        // }
    }
